  ...
  const CandleChart = dynamic(
    () => import('@/components/Trading/Chart/CandleChart'),
    {
      loading: () => (
        ...
        //     <svg
        //       aria-hidden="true"
        //       className="text-gray-200 dark:text-gray-600 fill-blue-600 mr-2 h-8 w-8 animate-spin"
        //       viewBox="0 0 100 101"
        //       fill="none"
      ...
      <>
        ...
        {candles ? (
          ...
          <div className="flex h-full w-full items-center justify-center">
            <div className="from-indigo-500 to-pink-500 flex h-14 w-14 animate-spin items-center justify-center rounded-full bg-gradient-to-tr">
