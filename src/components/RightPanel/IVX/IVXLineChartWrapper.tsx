    ...
    <div className="flex h-auto w-full flex-col gap-2 rounded bg-gray-500 p-3 md:h-44 lg:h-44">
      ...
      <div className="relative">
        ...
        {tokenPrice && !isHover && (
          <div
            className={clsx(
              'absolute right-14 flex items-center justify-center rounded bg-gray-400 py-1 px-2 text-xs font-normal text-white sm:right-40 xl:right-14',
              { 'top-0': isBuy, 'top-20': !isBuy }
            )}
          >
            <p>
